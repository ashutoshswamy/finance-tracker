      ...
      <div className="flex-1 flex items-center justify-center px-6 py-16">
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-1.5">
              <Label htmlFor="confirm" className="text-xs tracking-wide uppercase text-muted-foreground">
                Confirm password
              </Label>
              <PasswordInput
                id="confirm"
                ...
                required
                inputClassName={`bg-transparent border-0 border-b rounded-none px-0 py-2 text-sm focus-visible:ring-0 transition-colors placeholder:text-muted-foreground/40 ${
                  confirm && confirm !== password
                    ? "border-destructive focus-visible:border-destructive"
                    : "border-border/60 focus-visible:border-foreground/40"
                }`}
              />
              {confirm && confirm !== password && (
          ...
          <p className="text-center text-xs text-muted-foreground mt-8">
            ...
            <Link href="/login" className="text-foreground/70 hover:text-foreground underline underline-offset-4 transition-colors">
              Sign in
            </Link>
          </p>
        </div>
